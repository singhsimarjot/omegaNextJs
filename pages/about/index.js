...
const About = () => {
  ...
  return (
    <React.Fragment>
      ...
      <section className="position-relative">
        ...
        <div className="container px-4">
          <div className="col-md-12">
            ...
            <iframe width="100%" height="615" src="https://www.youtube.com/embed/xaUj-NCDu7c" title="YouTube video player" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="ClientsExperiences pb-5">
              ...
              Clients’ Experiences
                ...
                <p className="text-center text-white">Our clients return to us, saying we’re high performing, reliable, helpful, quick and productive.</p>
                  ...
                  <div className="row">
                      <div className="col-lg-4">
                          <div className="clientsCard bg-white text-center p-4">
                          <img
      ...
      <section>
          <div className="countingClients companyCards my-5 py-5">
          <div className="container">
          <div className="row">
            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div className="employees text-center">
                    <p className="counter-count text-white">879</p>
                    <p className="employee-p text-white">Employee</p>
                </div>
            </div>

            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div className="customer text-center">
                    <p className="counter-count text-white">954</p>
                    <p className="customer-p text-white">Customer</p>
                </div>
            </div>

            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div className="design text-center">
                    <p className="counter-count text-white">1050</p>
                    <p className="design-p text-white">Design</p>
                </div>
            </div>

            <div className="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                <div className="order text-center">
                    <p className="counter-count text-white">652</p>
                    <p className="order-p text-white">Orders</p>
                </div>
            </div>
        </div>
          </div>
