            ...
            <div className="backend2">
                <div className="container">
                    <div
                        ...
                        <ul className="nav footerNavs justify-content-center mb-md-0 offwhite d-flex align-items-center">
                            ...
                            <li><p className="nav-link px-2 link-dark fs-6 text-white mb-0">© {new Date().getFullYear()} Pixel Notation, All Rights
                                Reserved</p></li>
